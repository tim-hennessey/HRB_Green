...
app.Animation = (function () {
	...
	function start() {
		...
		tl.from(txt1a, .75, {y:"-=200", force3D:true, ease: Sine.easeOut})
		.from(txt1b, .75, {y:"-=200", force3D:true, ease: Sine.easeOut}, "-=.35")
		.from(txt1c, .75, {y:"-=200", force3D:true, ease: Sine.easeOut}, "-=.35");
