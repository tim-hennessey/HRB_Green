...
app.Animation = (function () {
	...
	var txt1i = document.getElementById('txt1i');
	var txt1j = document.getElementById('txt1j');
	var txt1k = document.getElementById('txt1k');
	...
	function start() {
		...
		.from(txt1i, .75, {y:"-=100", force3D:true, ease: Sine.easeOut}, "-=.35")
		.from(txt1j, .75, {y:"-=100", force3D:true, ease: Sine.easeOut}, "-=.35")
		.from(txt1k, .75, {y:"-=100", force3D:true, ease: Sine.easeOut}, "-=.35");
