...
app.Animation = (function () {
	...
	function start() {
		...
		.from(txt1b, .75, {y:"-=140", force3D:true, ease: Sine.easeOut}, "-=.35")
		.from(txt1c, .75, {y:"-=140", force3D:true, ease: Sine.easeOut}, "-=.35")
		.from(txt1d, .75, {y:"-=140", force3D:true, ease: Sine.easeOut}, "-=.35")
		.from(txt1e, .75, {y:"-=140", force3D:true, ease: Sine.easeOut}, "-=.35")
		.from(txt1f, .75, {y:"-=140", force3D:true, ease: Sine.easeOut}, "-=.35")
		.from(txt1g, .75, {y:"-=140", force3D:true, ease: Sine.easeOut}, "-=.35");
